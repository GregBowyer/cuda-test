...
//////////////////////////////////////////////////////////////////////////////
CUTBoolean loadPPM(const char* file, unsigned char** data, unsigned int *w, unsigned int *h, unsigned int *channels) {
	FILE *fp = NULL;
...
//! @param h     height of the image
//////////////////////////////////////////////////////////////////////////////
template<class T> CUTBoolean loadPGMt(const char* file, T** data, unsigned int *w, unsigned int *h) {
...
//! @param h     height of the image
//////////////////////////////////////////////////////////////////////////////
CUTBoolean savePPM(const char* file, unsigned char *data, unsigned int w, unsigned int h, unsigned int channels) {
...
//! @param h     height of the image
//////////////////////////////////////////////////////////////////////////////
template<class T> CUTBoolean savePGMt(const char* file, T *data, unsigned int w, unsigned int h) {
...
//! @param h     height of the image
//////////////////////////////////////////////////////////////////////////////
template<class T> CUTBoolean savePPMt(const char* file, T *data, unsigned int w, unsigned int h) {
...
//////////////////////////////////////////////////////////////////////////////
template<class T, class S> CUTBoolean compareData(const T* reference, const T* data, const unsigned int len, const S epsilon, const float threshold) {
...
//! @param epsilon    epsilon to use for the comparison
//////////////////////////////////////////////////////////////////////////////
template<class T, class S> CUTBoolean compareDataAsFloat(const T* reference, const T* data, const unsigned int len, const S epsilon) {
	CUT_CONDITION(epsilon >= 0);
...
//////////////////////////////////////////////////////////////////////////////
template<class T, class S> CUTBoolean compareDataAsFloatThreshold(const T* reference, const T* data, const unsigned int len, const S epsilon, const float threshold) {
	CUT_CONDITION(epsilon >= 0);
...
//////////////////////////////////////////////////////////////////////////////
template<class T> CUTBoolean cutReadFile(const char* filename, T** data, unsigned int* len, bool verbose) {
	...
	if (NULL != *data) {
		if (*len != data_read.size()) {
			std::cerr << "cutReadFile() : Initialized memory given but " << "size  mismatch with signal read " << "(data read / data init = "
					<< (unsigned int) data_read.size() << " / " << *len << ")" << std::endl;
...
//////////////////////////////////////////////////////////////////////////////
template<class T> CUTBoolean cutWriteFile(const char* filename, const T* data, unsigned int len, const T epsilon, bool verbose) {
	CUT_CONDITION(NULL != filename);
	CUT_CONDITION(NULL != data);
...
//! @param len  number of data elements in data, -1 on error
////////////////////////////////////////////////////////////////////////////////
CUTBoolean CUTIL_API cutReadFileb(const char* filename, char** data, unsigned int* len, bool verbose) {
	return cutReadFile(filename, data, len, verbose);
}
...
DLL_MAPPING CUTBoolean CUTIL_API
...
//! TBD
////////////////////////////////////////////////////////////////////////////////
void CUTIL_API cutCheckBankAccess( unsigned int tidx, unsigned int tidy, unsigned int tidz,
